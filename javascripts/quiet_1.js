...
var Quiet = (function() {
    ...
    function createAudioInput() {
        ...
        window.setTimeout(function() {
            ...
            .then(function(stream) {
                ...
                console.log("INPUTTT", audioInput);
    ...
    function receiver(opts) {
        ...
        if (gUM === undefined) {
            ...
            gUM = (navigator.mediaDevices.getUserMedia(constraints) || navigator.webkitGetUserMedia || navigator.mozGetUserMedia);
        }
        ...
        var readbuf = function() {
            ...
            while (true) {
                ...
                if (read === -1) {
                    //console.log("reading?", [decoder, frame, frameBufferSize]);
                    break;
                }
                // convert from emscripten bytes to js string. more pointer arithmetic.
                var frameArray = Module.HEAP8.slice(frame, frame + read);
                console.log(frameArray,     Module.HEAP8.slice());
                console.log("bufferino", frameArray.buffer);
